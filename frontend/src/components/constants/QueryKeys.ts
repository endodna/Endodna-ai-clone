...
export const queryKeys = {
  doctor: {
    ...
    patients: {
      ...
      detail: (id: string) =>
        [...queryKeys.doctor.patients.all(), "detail", id] as const,
      summary: (id: string) =>
        [...queryKeys.doctor.patients.all(), "summary", id] as const,
      medications: (id: string) =>
        [...queryKeys.doctor.patients.all(), "medications", id] as const,
      create: (patientData: AddPatientData) =>
        [...queryKeys.doctor.patients.all(), "create", patientData] as const,
      goals: {
        list: (
          patientId: string,
          ...
          [
            ...queryKeys.doctor.patients.all(),
            "goals",
            patientId,
            params,
          ] as const,
        detail: (patientId: string, goalId: string) =>
          [
            ...queryKeys.doctor.patients.all(),
            "goals",
            patientId,
    ...
    chat: {
      ...
      patient: {
        ...
        conversations: (patientId: string) =>
          [
            ...queryKeys.doctor.chat.patient.all(),
            "conversations",
            patientId,
          ] as const,
        ...
        allPatients: () =>
          [...queryKeys.doctor.chat.patient.all(), "all-patients"] as const,
      },
      general: {
        all: () => [...queryKeys.doctor.chat.all(), "general"] as const,
        conversations: () =>
          [...queryKeys.doctor.chat.general.all(), "conversations"] as const,
        conversationMessages: (conversationId: string) =>
          [
            ...queryKeys.doctor.chat.general.all(),
            "messages",
            conversationId,
          ] as const,
      },
    ...
    dna: {
      ...
      results: (patientId: string) =>
        [...queryKeys.doctor.dna.all(), "results", patientId] as const,
      reports: (gender: string | null | undefined) =>
        [...queryKeys.doctor.dna.all(), "reports", gender ?? "ALL"] as const,
      geneticsReports: (patientId: string) =>
        [...queryKeys.doctor.dna.all(), "genetics-reports", patientId] as const,
      addresses: (patientId: string) =>
        [...queryKeys.doctor.dna.all(), "addresses", patientId] as const,
    },
    dosing: {
